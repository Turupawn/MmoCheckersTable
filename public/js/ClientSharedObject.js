...
var ClientSharedObject = function (game, startX, startY) {
  this.game = game
  this.my_sprite = game.add.sprite(startX, startY, 'shared_object')
...
function onDragStop(sprite, pointer) {
  ...
  socket.emit('move object', { x: new_position_x, y: new_position_y })
